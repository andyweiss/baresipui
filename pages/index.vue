<template>
  <div class="min-h-screen bg-gray-50">
    <header class="bg-white shadow">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div class="flex items-center justify-between">
          <h1 class="text-3xl font-bold text-gray-900">Baresip Control Dashboard</h1>
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <section class="mb-8">
        <h2 class="text-2xl font-bold text-gray-900 mb-4">SIP Accounts</h2>
        <div v-if="accounts.length === 0" class="bg-white rounded-lg shadow p-8 text-center">
          <p class="text-gray-500">No accounts registered yet</p>
        </div>
      ...
      <section>
        <h2 class="text-2xl font-bold text-gray-900 mb-4">Auto-Connect Contacts</h2>
        <div v-if="contacts.length === 0" class="bg-white rounded-lg shadow p-8 text-center">
          <p class="text-gray-500">No contacts configured</p>
          <p class="text-sm text-gray-400 mt-2">Add contacts via API or configuration</p>
        </div>
